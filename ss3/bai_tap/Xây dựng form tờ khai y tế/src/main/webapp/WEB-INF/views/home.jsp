...
<form:form  style="margin: 50px 5% 0px 5%" modelAttribute="form" method="post" action="/send">
    ...
    <div>
    <form:label path="idCard" for="inputCMND" >Số hộ chiếu hoặc số CMND hoặc giấy thông hành hợp lệ khác <span style="color: red">(*)</span></form:label>
    ...
    <div>
    <form:label path="vehicleNumber" for="inputvehicleNumber">Số hiệu phương tiện <span style="color: red">(*)</span></form:label>
    ...
    <div>
    <form:label path="startDate" for="inputStartDate" >Ngày khởi hành <span style="color: red">(*)</span></form:label>
    ...
    <div>
    <form:label path="location14Day" for="keKhai">Trong vòng 14 ngày qua, Anh/Chị có đến tỉnh thành phố nào? <span style="color: red">(*)</span></form:label>
